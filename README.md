# webpack-template<!-- @format -->
# 📗 Table of Contents

- [webpack-template](#webpack-template)
- [📗 Table of Contents](#-table-of-contents)
- [📖 \["Todo-list project of Microverse\] ](#-todo-list-project-of-microverse-)
...
# 📖 ["Todo-list project of Microverse] <a name="about-project"></a>

> This project is about displaying todo list from array object

**[Todo-list project of Microverse]** is a great project for beginners to learn how to build a simple use objects
...
```sh
git clone https://github.com/ghermaico135/todo-list.git
```

then you will see the **todo-list** on your system then type this:
...
Inside **todo-list** you can install the node and run npm start open it inside your browser.
...
Feel free to check the [issues page] (https://github.com/ghermaico135/todo-list/issues).
